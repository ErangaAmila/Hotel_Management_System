...
<!-- END Navigation bar -->
<br>
<h2 style="text-align:center;">UPDATE ROOM DETAILS</h2>
<br>
...
<div class="row justify-content-center">
    ...
    <input type="file" name="eventPhoto" class="form-control-file" id="exampleFormControlFile1">
  </div>
    </div>
  </div>
  <br>
  ...
  <div class="row justify-content-center">
    ...
    <div class="col-4">
      <input type="text" class="form-control " name="roomID" id="validationServer05" placeholder="Room ID" required value="<%= eventID %>" readonly>
      <br>
    </div>
  </div>
  ...
  <div class="row justify-content-center">
    ...
    <div class="col-4">
    <select class="form-control" name="roomName" id="exampleFormControlSelect1" value="<%= eventName %>">
  ...
  <div class="row justify-content-center">
    ...
    <div class="col-4">
      <input class="form-control" name="roomDescription" id="exampleFormControlTextarea1" rows="3" value="<%= eventDescription %>"></textarea>
    </div>
  </div>
  <br>
  ...
  <div class="row justify-content-center">
    ...
    <div class="col-4">
      <input type="text" class="form-control" name="roomPrice" id="validationServer05" placeholder="Room Price" required value="<%= eventPrice %>">
      <div class="invalid-feedback">
        Please provide Event Price Here.
      </div>
    </div>
  </div>
   ...
   <div class="row justify-content-center">
    <div class="col-2">
      <button type="submit" class="btn btn-primary mb-2" name="submit" value="Update Room">Confim Update</button>
    </div>
    <div class="col-4">
    </div>
  </div>
