...
<!-- END Navigation bar -->
<br>
<a href="roomDetailsInsert.jsp" class="btn btn-add" style="float:right; margin:20px;">Add Room</a>
<br>
...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm">
    <h2 style="text-align:center;">ROOM TYPES</h2>
    </div>
    <div class="col-sm">
    <hr>
    </div>
...
<div class="container">
  ...
  <div class="card-body">
    ...
    <p class="card-text"><b> Room size 35 m² </b><br>
    <h6>Comfy beds, 9.4 – Based on 993 reviews </h6>
    <p>This King room has a spacious bathroom with glass enclosed, privileged access to the iconic infinity pool & rooftop garden.</p>
  ...
  <div class="card-body">
    ...
    <p class="card-text"><b> Room size 35 m² </b>
    <h6>Comfy beds, 9.4 – Based on 993 reviews </h6>
    <p>This Twin room has spacious bathroom with glass enclosed, privileged access to the iconic infinity pool & rooftop garden.</p>
    </p>
    <h5>Price $280</h3>
    <a href="#" class="btn btn-primary">BOOK NOW</a>
  </div>
  ...
  <div class="card-body">
    ...
    <p class="card-text">
    <b>  Room size 35 m² </b>
    <h6>Comfy beds, 9.4 – Based on 1393 reviews </h6>
    <p>This twin room has a balcony, attached bathroom. Guests have privileged access to the infinity pool & rooftop garden.</p>
  ...
  <div class="card-body">
    <h5 class="card-title">PREMIER KING ROOM</h5>
    <p class="card-text"><b>  Room size 35 m² </b>
    <h6>Comfy beds, 9.4 – Based on 1393 reviews </h6>
    <p>This twin room has a balcony, attached bathroom. Guests have privileged access to the infinity pool & rooftop garden.</p></p>
    <h5>Price $420</h3>
    <a href="#" class="btn btn-primary">BOOK NOW</a>
  </div>
</div>
