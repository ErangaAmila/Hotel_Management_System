...
<div class="row justify-content-center">
  ...
  <div class="row justify-content-center">
    ...
    <div class="col-4">
      <input type="text" class="form-control is-invalid" name="eventID" id="validationServer05" placeholder="Event ID" required>
      <div class="invalid-feedback">
        Please provide Event ID Here.
      </div>
    </div>
  </div>
  ...
  <div class="row justify-content-center">
    ...
    <div class="col-4">
    <select class="form-control" name="eventName" id="exampleFormControlSelect1">
  ...
  <div class="row justify-content-center">
    ...
    <div class="col-4">
      <textarea class="form-control" name="eventDescription" id="exampleFormControlTextarea1" rows="3"></textarea>
    </div>
  </div>
  <br>
  ...
  <div class="row justify-content-center">
    ...
    <div class="col-4">
      <input type="text" class="form-control " name="eventPrice" id="validationServer05" placeholder="Room Price" required>
      <div class="invalid-feedback">
  ...
  <br>
   <div class="row justify-content-center">
    <div class="col-2">
      <button type="submit" class="btn btn-primary mb-2" name="submit" value="Create Room">Add Event</button>
    </div>
    <div class="col-4">
    </div>
  </div>
