...
<div class="row justify-content-center">
  ...
  <div class="row justify-content-center">
    ...
    <div class="col-4">
      <input type="text" class="form-control " name="roomID" id="validationServer05" placeholder="Room ID" required value="<%= roomID %>" readonly>
      <br>
    </div>
  </div>
  ...
  <div class="row justify-content-center">
    ...
    <div class="col-4">
    <select class="form-control" name="roomName" id="exampleFormControlSelect1" value="<%= roomName %>"readonly>
  ...
  <div class="row justify-content-center">
    ...
    <div class="col-4">
      <input class="form-control" name="roomDescription" id="exampleFormControlTextarea1" rows="3" value="<%= roomDescription %>"readonly></textarea>
    </div>
  </div>
  <br>
  ...
  <div class="row justify-content-center">
    ...
    <div class="col-4">
      <input type="text" class="form-control" name="roomPrice" id="validationServer05" placeholder="Room Price" required value="<%= roomPrice %>"readonly>
