...
<div class="row justify-content-center">
  ...
  <div class="row justify-content-center">
    ...
    <div class="col-4">
      <input type="text" class="form-control is-invalid" name="foodCode" id="validationServer05" placeholder="Food Code" required value="<%= foodCode %>">
  ...
  <div class="row justify-content-center">
    ...
    <div class="col-4">
    <select class="form-control" name="foodCategory" id="exampleFormControlSelect1" value="<%= foodCategory %>">
      <option>PIZZA</option>
  ...
  <div class="row justify-content-center">
    ...
    <div class="col-4">
      <input class="form-control" name="foodName" id="exampleFormControlTextarea1" rows="3" value="<%= foodName %>"></textarea>
    </div>
  </div>
  <br>
  <div class="row justify-content-center">
    ...
    <div class="col-4">
      <textarea class="form-control" name="foodDescription" id="exampleFormControlTextarea1" rows="3" value="<%= foodDescription %>"></textarea>
    </div>
  </div>
  <br>
  ...
  <div class="row justify-content-center">
    ...
    <div class="col-4">
      <input type="text" class="form-control is-invalid" name="foodPrice" id="validationServer05" placeholder="Food Price" required value="<%= foodPrice %>">
      <div class="invalid-feedback">
   ...
   <div class="row justify-content-center">
    <div class="col-2">
      <button type="submit" class="btn btn-primary mb-2" name="submit" value="Update Room">Updates Food</button>
    </div>
    <div class="col-4">
    </div>
  </div>
