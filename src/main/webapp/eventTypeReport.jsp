...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm">
    <h2 style="text-align:center;">Event TYPE REPORT</h2>
    </div>
    <div class="col-sm">
    <hr>
    </div>
...
%>
  ...
  <tbody>
    <tr>
      ...
      <td><%=resultSet.getString("eventPrice") %></td>
...
<button class = "btn" id = "downloadPDFWithBrowserPrint" onClick = "downloadPDFWithBrowserPrint()"><i class="fa fa-download"></i> Download</button>
...
document.querySelector('#browserPrint').addEventListener('click', $("#downloadPDFWithBrowserPrint"));</script>
</html>