...
<body>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item"><a class="nav-link"
						href="CustomerReg.jsp" tabindex="-1" aria-disabled="true">Register</a></li>
	...
	<!-- END Navigation bar -->
	<br>
	<h2 style="text-align: center;">ADD A ROOM</h2>
	...
	<form action="insert" method="post">
		<div class="row justify-content-center">
			...
			<div class="col-4">
				<div class="form-group">
					<input type="file" name="roomPhoto" class="form-control-file"
		...
		<div class="row justify-content-center">
			...
			<div class="col-4">
				<input type="text" class="form-control is-invalid" name="roomID"
					id="validationServer05" placeholder="Room ID" required>
				<div class="invalid-feedback">Please provide Room ID Here.</div>
			</div>
		</div>
		...
		<div class="row justify-content-center">
			...
			<div class="col-4">
				<textarea class="form-control" name="roomDescription"
		...
		<div class="row justify-content-center">
			...
			<div class="col-4">
				<input type="text" class="form-control " name="roomPrice"
					id="validationServer05" placeholder="Room Price" required>
				<div class="invalid-feedback">Please provide Room Price Here.
				</div>
			</div>
		</div>
		<br>
		<div class="row justify-content-center">
			<div class="col-2">
				<button type="submit" class="btn btn-primary mb-2" name="submit"
					value="Create Room">Add Room</button>
			</div>
			<div class="col-4"></div>
		</div>
