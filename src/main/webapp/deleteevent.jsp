...
<!-- END Navigation bar -->
<br>
<h2 style="text-align:center;">DELETE ROOM DETAILS</h2>
<br>
...
<div class="row justify-content-center">
  ...
  <div class="row justify-content-center">
    ...
    <div class="col-4">
      <input type="text" class="form-control " name="eventID" id="validationServer05" placeholder="Room ID" required value="<%= eventID %>" readonly>
      <br>
    </div>
  </div>
  ...
  <div class="row justify-content-center">
    ...
    <div class="col-4">
    <select class="form-control" name="eventName" id="exampleFormControlSelect1" value="<%= eventName %>"readonly>
  ...
  <div class="row justify-content-center">
    ...
    <div class="col-4">
      <input class="form-control" name="eventDescription" id="exampleFormControlTextarea1" rows="3" value="<%= eventDescription %>"readonly></textarea>
    </div>
  </div>
  <br>
  ...
  <div class="row justify-content-center">
    ...
    <div class="col-4">
      <input type="text" class="form-control" name="eventPrice" id="validationServer05" placeholder="Room Price" required value="<%= eventPrice %>"readonly>
      <div class="invalid-feedback">
        Please provide Room Price Here.
      </div>
    </div>
  </div>
   ...
   <div class="row justify-content-center">
    <div class="col-2">
      <button type="submit" class="btn btn-primary mb-2" name="submit" value="Delete this room">Confirm Delete</button>
    </div>
    <div class="col-4">
    </div>
  </div>
