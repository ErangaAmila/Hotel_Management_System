...
<div class="container">
  ...
  <img src="Images/PremiumW.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    ...
    <div class="col-sm">
      <div class="card" style="width: 18rem;">
  <img src="Images/FullsetW.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    ...
    <div class="col-sm">
      <div class="card" style="width: 18rem;">
  <img src="Images/MiddleW.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    ...
    <div class="col-sm">
      <div class="card" style="width: 18rem;">
  <img src="Images/NormalW.jpg" class="card-img-top" alt="...">
  <div class="card-body">
